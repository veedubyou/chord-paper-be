...
backup-production:
	python ./scripts/dynamodump.py -m backup -r us-east-2 -s "*" --accessKey AKIAJFVPHEENP5LSDZ4Q --secretKey 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 --dumpPath ./db_dump
