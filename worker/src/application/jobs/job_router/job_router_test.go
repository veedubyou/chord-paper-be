...
import (
	...
	"github.com/veedubyou/chord-paper-be/worker/src/application/jobs/save_stems_to_db/save_stems_to_dbfakes"
	"github.com/veedubyou/chord-paper-be/worker/src/application/jobs/split"
	"github.com/veedubyou/chord-paper-be/worker/src/application/jobs/split/splitfakes"
	...
	"github.com/veedubyou/chord-paper-be/worker/src/application/jobs/start/startfakes"
	"github.com/veedubyou/chord-paper-be/worker/src/application/jobs/transfer"
	"github.com/veedubyou/chord-paper-be/worker/src/application/jobs/transfer/transferfakes"
